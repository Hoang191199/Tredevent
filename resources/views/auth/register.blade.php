            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-group row">
                            <label for="sdt" class="col-md-4 col-form-label text-md-right"></label>

                            <div class="col-md-6">
                                <input id="sdt" type="text" class="form-control @error('sdt') is-invalid @enderror" name="sdt" value="{{ old('sdt') }}" required autocomplete="sdt" placeholder="Số điện thoại">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" action="{{ route('register') }}">
                                    {{ __('Đăng ký') }}
                                </button>
                            </div>
                        </div>
