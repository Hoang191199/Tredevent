                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <div class="submit-1">
                                    <button type="submit" class="btn btn-primary">FABOOK</button>
                                    <button type="submit" class="btn btn-danger">GOOGLE</button>
                                </div>

                                <div class="submit-2">
                                    <p class="login-with-1">
                                        Bạn có tài khoản chưa? <a href="">Đăng ký ngay</a>
                                    </p>
                                </div>
