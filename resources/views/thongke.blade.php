...
@section('content')
    ...
    <div id="main" class="page-full-width sk-flex-display">
        <div class="container-fuilt" style="background-color: white">
            <div class="row">
                <div class="col-sm-1 ">
                        ...
                        <div class="wrap-statistical mt-10">
                            <form action="" id="w0">
                                <div class="staistical-schedule">
                                    <select id="w1"
                                        class="statistic-select-schedule form-control select2-hidden-accessible "
                                        style="margin-bottom: 10px">
                                        <option value="">Chọn lịch cần thống kê...</option>
                                        <option value="">Hà Nội, 20/05/2021</option>
                                    </select>
                            ...
                            <div id="orders_chart"
                                ...
                                <div id="highcharts-s4mpy8d-0" class="highcharts-container "
                                    style="position: relative; overflow: hidden; width: 1132px; height: 400px; text-align: left; line-height: normal; z-index: 0; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); user-select: none; touch-action: manipulation; outline: none;">
                                    <svg class="highcharts-root"
                                        style="font-family:&quot;Lucida Grande&quot;, &quot;Lucida Sans Unicode&quot;, Arial, Helvetica, sans-serif;font-size:12px;"
                                        xmlns="http://www.w3.org/2000/svg" width="1132" height="400" viewBox="0 0 1132 400">
                                        ...
                                        <rect fill="#ffffff" class="highcharts-background" x="0" y="0" width="1132"
                                            height="400" rx="0" ry="0"></rect>
                                        <rect fill="none" class="highcharts-plot-background" x="39" y="53" width="1083"
                                            height="290"></rect>
                                        ...
                                        <rect fill="none" class="highcharts-plot-border" data-z-index="1" x="39" y="53"
                                            width="1083" height="290"></rect>
                                        <g class="highcharts-axis highcharts-xaxis">
                                            <path fill="none" class="highcharts-axis-line" stroke="#ccd6eb" stroke-width="1"
                                                data-z-index="7" d="M 39 343.5 L 1122 343.5"></path>
                                        </g>
                                        <g class="highcharts-axis highcharts-yaxis">
                                            <text x="26.5" data-z-index="7" text-anchor="middle"
                                                transform="translate(0,0) rotate(270 26.5 198)"
                                                class="highcharts-axis-title" style="color:#666666;fill:#666666;" y="198">Số
                                                lượng</text>
                                            <path fill="none" class="highcharts-axis-line" data-z-index="7"
                                                d="M 39 53 L 39 343"></path>
                                        </g>
                                        ...
                                        <g class="highcharts-exporting-group" data-z-index="3">
                                            <g class="highcharts-button highcharts-contextbutton" stroke-linecap="round"
                                                ...
                                                <text x="0" data-z-index="1" y="12"
                                                    style="color:#333333;font-weight:normal;fill:#333333;"></text>
                                            </g>
                                        </g>
                                        <text x="566" text-anchor="middle" class="highcharts-title" data-z-index="4"
                                            style="color:#333333;font-size:18px;fill:#333333;" y="24">Thống kê đơn
                                            hàng</text>
                                        <text x="566" text-anchor="middle" class="highcharts-subtitle" data-z-index="4"
                                        ...
                                        <g class="highcharts-data-labels highcharts-series-0 highcharts-line-series highcharts-color-0"
                                            data-z-index="6" opacity="1" transform="translate(39,53) scale(1 1)"></g>
                                        <g class="highcharts-legend" data-z-index="7" transform="translate(518,355)">
                                            <rect fill="none" class="highcharts-legend-box" rx="0" ry="0" x="0" y="0"
                                                width="95" height="30" visibility="visible"></rect>
                                            <g data-z-index="1">
                                                <g>
                                                    <g class="highcharts-legend-item highcharts-line-series highcharts-color-0 highcharts-series-0"
                                                        ...
                                                        <path fill="#7cb5ec"
                                                            ...
                                                            text-anchor="start" data-z-index="2" y="15">Đơn hàng</text>
                                                    </g>
                                                </g>
                                            </g>
                                        </g>
                                        ...
                                        <text x="1122" class="highcharts-credits" text-anchor="end" data-z-index="8"
                            ...
                            <div class="statistic-event row">
                                <div class="statistic-event-box col-md-3 col-sm-3 col-xs-12">
                                    <div class="statictic-one statistic-event-icon">
                                        ...
                                        <div class="statistic-text"> Tổng đơn {{ $Statistics->total }}</div>
                                    </div>
                                </div>
                                <div class="statistic-event-box col-md-3 col-sm-3 col-xs-12">
