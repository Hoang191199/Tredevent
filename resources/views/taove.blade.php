...
<div class="wrap-schedule-list flex-col-right">
    <div class="navbar-main schedule-list">
        <form id="form-add-ticket" action="{{ $createVe->SUKIEN_ID }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="wrap-add-event">
                <div class="ticket-info-content form-add-event">
                    <h1 class="add-event-heading">Thêm vé</h1>
                    @if (session('success'))
                ...
                @endif
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="form-group field-ticket-limits">
                                ...
                                <input type="number" id="ticket-limits" class="form-control" name="soluong"
                                    min="0">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6">
                            <div class="form-group field-ticket-price_origin required">
                                ...
                                <input type="number" id="ticket-price_origin" class="form-control"
                                    name="giave" min="0" aria-required="true" >
                                    @if ($errors->has('giave'))
                    ...
                    <div class="form-group field-ticket-description required has-error">
                        ...
                        <textarea id="ticket-description" class="form-control" name="mota" rows="8"
                            placeholder="Mô tả cho vé" aria-required="true" aria-invalid="true"></textarea>

                        {{-- <div class="help-block">Mô tả vé không được để trống.</div> --}}
                    </div>
                    <div class="wrap-event-submit">
                        <button type="submit" class="btn btn-success" name="save"><i class="fa fa-save"></i> Lưu lại</button>
                    </div>
                </div>
            </div>
        </form>
